...
MonoBehaviour:
  ...
  m_Name: 
  m_EditorClassIdentifier: Unity.InputSystem::UnityEngine.InputSystem.Editor.InputDebuggerWindow
  m_MinSize: {x: 50, y: 50}
  m_MaxSize: {x: 4000, y: 4000}
  m_TitleContent:
    m_Text: Input Debug
    m_Image: {fileID: 0}
    m_Tooltip: 
    m_TextWithWhitespace: "Input Debug\u200B"
  m_Pos:
    serializedVersion: 2
    x: 1920
    y: 99
...
MonoBehaviour:
  ...
  m_Enabled: 1
  m_EditorHideFlags: 0
  m_Script: {fileID: 11500000, guid: 4c4b976aff292d31ea989f6d5dac8588, type: 3}
  m_Name: 
  m_EditorClassIdentifier: Antigravity.Toolkit.Editor::Antigravity.Editor.AntigravityConsole
  m_MinSize: {x: 50, y: 50}
  m_MaxSize: {x: 4000, y: 4000}
  m_TitleContent:
    m_Text: Editor Logs
    m_Image: {fileID: 1407345384548418524, guid: 0000000000000000d000000000000000, type: 0}
    m_Tooltip: 
    m_TextWithWhitespace: "Editor Logs\u200B"
  m_Pos:
    serializedVersion: 2
    x: 0
    y: 502.5
...
MonoBehaviour:
  ...
  m_OverlayCanvas:
    ...
    - dockPosition: 0
      ...
      id: Orientation
      index: 0
      contents: '{"m_Layout":4,"m_Collapsed":false,"m_Folded":false,"m_Floating":false,"m_FloatingSnapOffset":{"x":0.0,"y":-57.5},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":2,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 0
      collapsed: 0
      snapOffset: {x: 0, y: -57.5}
      snapOffsetDelta: {x: 0, y: 0}
      snapCorner: 2
      layout: 4
      size: {x: 0, y: 0}
    ...
    - dockPosition: 1
      ...
      index: 4
      contents: '{"m_Layout":4,"m_Collapsed":false,"m_Folded":true,"m_Floating":false,"m_FloatingSnapOffset":{"x":0.0,"y":0.0},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":0,"m_Size":{"x":410.0,"y":180.0},"m_SizeOverridden":true}'
      floating: 0
      collapsed: 0
      snapOffset: {x: 0, y: 0}
      snapOffsetDelta: {x: 0, y: 0}
    ...
    - dockPosition: 1
      ...
      index: 11
      contents: '{"m_Layout":4,"m_Collapsed":false,"m_Folded":true,"m_Floating":false,"m_FloatingSnapOffset":{"x":-207.0,"y":-431.0},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":3,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 0
      collapsed: 0
      snapOffset: {x: -207, y: -431}
      snapOffsetDelta: {x: 0, y: 0}
      snapCorner: 3
      layout: 4
      size: {x: 0, y: 0}
    ...
    - dockPosition: 0
      ...
      index: 0
      contents: '{"m_Layout":4,"m_Collapsed":false,"m_Folded":false,"m_Floating":true,"m_FloatingSnapOffset":{"x":0.0,"y":0.0},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":0,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 1
      collapsed: 0
      snapOffset: {x: 0, y: 0}
      snapOffsetDelta: {x: 0, y: 0}
  ...
  m_Position:
    m_Target: {x: -4.2575903, y: 0.0018385649, z: -0.6670308}
    speed: 2
    m_Value: {x: -4.2575903, y: 0.0018385649, z: -0.6670308}
  m_RenderMode: 0
  m_CameraMode:
    drawMode: 0
    name: Shaded
  ...
  m_Grid:
    ...
    m_gridOpacity: 0.5
  m_Rotation:
    m_Target: {x: 0.2366796, y: 0.41659293, z: -0.1132799, w: 0.8704042}
    speed: 2
    m_Value: {x: 0.2366796, y: 0.41659293, z: -0.11327991, w: 0.8704042}
  m_Size:
    m_Target: 1.6944321
    speed: 2
    m_Value: 1.6944321
...
MonoBehaviour:
  ...
  m_TreeViewState:
    ...
    m_ExpandedIDs: 67e1b582a01a5fa667ea4eb1000000007f0eae07e594f01a
    m_RenameOverlay:
      m_UserAcceptedRename: 0
      m_Name: 
      m_OriginalName: 
...
MonoBehaviour:
  ...
  m_TreeViewState:
    ...
    m_ExpandedIDs: 2956c29689577ec10000000001fecd1127fb9b14
    m_RenameOverlay:
      m_UserAcceptedRename: 0
      m_Name: 
      m_OriginalName: 
...
MonoBehaviour:
  ...
  m_ZoomArea:
    ...
    m_Translation: {x: 456.4758, y: 217.74997}
    m_MarginLeft: 0
    m_MarginRight: 0
    m_MarginTop: 0
    m_MarginBottom: 0
    m_LastShownAreaInsideMargins:
      ...
      height: 314.61456
    m_MinimalGUI: 1
  m_defaultScale: 0.8064815
  m_LastWindowPixelSize: {x: 970, y: 456.5}
  m_ClearInEditMode: 1
  m_NoCameraWarning: 1
...
MonoBehaviour:
  ...
  m_LastProjectPath: /home/invisible/Unity/Antigravity Workflow
  m_LockTracker:
    m_IsLocked: 0
